...
BEGIN
	...
	VALUES (current_user_id, p_application_type, 'pending');
...
REVOKE EXECUTE ON FUNCTION public.submit_role_application(application_type, JSONB) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.submit_role_application(application_type, JSONB) TO authenticated;
